...
import { main as addLiquidity } from "./addLiquidityETH";
...
const main = async () => {
  ...
  const transaction = await UniRouterContract.removeLiquidityETH(
    DAIAddress,
    lpBalance, //liquidity
    0n,  // amountAMin = 0, meaning accept any amount of DAI back (no slippage protection)
    0n,  // amountBMin   = 0, meaning accept any amount of ETH back (no slippage protection)
